...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            className="sticky top-14 h-[calc(100vh-4rem)] w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="group peer sticky top-14 hidden h-[calc(100vh-3.5rem)] text-sidebar-foreground md:block"
        data-state={state}
