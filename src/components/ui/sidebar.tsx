...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            className="sticky h-[calc(100vh-4rem)] top-14 w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="h-[calc(100vh-3.5rem)] sticky top-14 group peer hidden text-sidebar-foreground md:block"
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
                  "fixed h-svh w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear",
        ...
        <div
          className={cn(
            "inset-y-0 z-10 flex h-full w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear",
            side === "left"
