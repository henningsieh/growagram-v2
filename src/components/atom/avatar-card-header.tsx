      ...
      <div className="flex items-center gap-0">
        ...
        >
          <CustomAvatar
            ...
            className="ring-muted-foreground ring-1 transition-colors duration-200 ease-in-out group-hover:ring-2"
          />
          <div className="flex items-center gap-2 text-sm whitespace-nowrap">
            <p className="text-foreground font-bold underline-offset-4 group-hover:underline">
              {user.name}
            </p>
            ...
            <span className="xs:block text-muted-foreground group-hover:text-foreground hidden transition-colors">
              {`@${user.username}`}
            </span>
          </div>
        </Link>
